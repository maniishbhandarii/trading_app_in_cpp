...
public:
  ...
  void History() {
    ...
    char temp;
    cout << "Do you want to clear all transactions(Enter 'Y' for yes and any other key for no ):";
    cin >> temp;
...
int main() {
  ...
  while (1) {
    ...
    cout << endl;
    cout << "Press 1 if want to have your Account Info " << endl;
    cout << "Press 2 if want to Deposit your money " << endl;
    cout << "Press 3 if want to withdraw your money " << endl;
    cout << "Press 4 if want to know your history " << endl;
    cout << "Press 5 if want to know your Buy Crypto " << endl;
    cout << "Press 6 if want to know your Sell Crypto " << endl;
